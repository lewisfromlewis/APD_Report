...
# There is one way to get the data and one only. May be https://comet.anzics.com.au/api/v1/reports/runreport which is the content of POST on developer tools in Firefox
