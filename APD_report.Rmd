...
The readmission rate is a source of perennial interest. In sympathy with the language of patient journeys, The expectation may be that on discharge from ICU, patients are either a path to wellness or death and 
