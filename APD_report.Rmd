...
SPICY <- APD %>% filter(INVDayOne=="Yes" & INV_Hrs>48 & AgeICU>=65 & TreatmentGoals=="Full Active Treatment" & ICUAdmission == "First" & Frailty %in% c("Well", "ManagingWell", "MildlyFrail", "ModeratelyFrail"))
